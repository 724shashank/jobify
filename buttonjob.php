...
<br><br>
      ...
      $q1="select  regcmp.logo,regcmp.oname,jobs.jtitle,jobs.jloc,jobs.eligi,jobs.salary,jobs.post,jobs.last,jobs.disc,jobs.jid,jobs.user from regcmp,jobs where jobs.user=regcmp.email and regcmp.email='$comp'";
     ...
     echo"<hr>";
     echo"<h2 style='display:inline;margin-left:10px;color:#FF9900;'>".$row[3]."</h2>&nbsp;&nbsp;<img src='images/loc.png' style='width:20px;height:25px;'><h2 style='display:inline;margin-left:380px;color:grey;'><img src='images/cal.png' style='width:20px;height:25px;'>&nbsp;&nbsp;<span style='color:#FF9900;'>Last Date :</span>".$row[7]."</h2><a href='apply.php?id=".$row[9]."&id2=".$row[10]."' style='text-decoration:none;'><button style='display:inline;margin-left:325px;height:50px;width:100px;font-family: Arial Black;background-color:#FF9900;color:black;'>Apply</button></a>";
     echo"<hr></div><br>";
     }
     ?>
