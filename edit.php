...
<table style="font-family:Arial Black;">
	<tr><td colspan="3" style="text-align: center;background-color:#FF9900;font-family:Arial Black;font-size:30pt;">Edit Question</td></tr>
<tr><td><h3>Enter Your Question ID:&nbsp;&nbsp;</h3></td><td><input type="number" name="id" class="input" style="width:250px;height: 30px;"></td></tr>
