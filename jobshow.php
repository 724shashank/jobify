...
<br><br>
      ...
      $q1="select  regcmp.logo,regcmp.oname,jobs.jtitle,jobs.jloc,jobs.eligi,jobs.salary,jobs.post,jobs.last,jobs.disc,jobs.jid from regcmp,jobs where jobs.user=regcmp.email";
