...
<br><br>
     ...
     <style type="text/css">
      ...
      $q1="select  regcmp.logo,regcmp.oname,jobs.jtitle,jobs.jloc,jobs.eligi,jobs.salary,jobs.post,jobs.last,jobs.disc,jobs.jtype,jobs.jrole,jobs.jcat,jobs.jhir,jobs.jwho from regcmp,jobs where jobs.jid='$id' AND jobs.user=regcmp.email";
     ...
     echo"<a href='indlog.php' style='text-decoration:none;'><button>Login To Apply</button></a>";
     echo"</div>";
